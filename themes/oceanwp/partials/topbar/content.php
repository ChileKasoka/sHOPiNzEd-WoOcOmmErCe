		...
		if ( ! empty( $template ) ) {
			...
			if ( !empty($content)
				...
				<span class="topbar-content">
					...
					<?php
					// Display top bar content from Customizer.
					if ( !empty($content) ) {
						echo do_shortcode( $content );
					}
					?>

					<!-- 🔥 Custom Hardcoded Contact Info -->
					<span class="top-phone">📞 +260 97 123 4567</span>
					<span class="top-email">✉️ sales@shopinzed.com</span>
